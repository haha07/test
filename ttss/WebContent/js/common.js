...
function clickSearch400() {
	$("#search-state").find("img").attr("src", "images/map/map_control_400.png");
	$("#search-container").css("visibility", "hidden");
	$("#search-state").removeClass("state-show");
}

function clickSearch800() {
	$("#search-state").find("img").attr("src", "images/map/map_control_800.png");
	$("#search-container").css("visibility", "hidden");
	$("#search-state").removeClass("state-show");
}
//gnb
